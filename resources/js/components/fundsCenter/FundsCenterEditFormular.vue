...
<script>
    export default {
        ...
        created() {
            this.form.fond = this.fundsCenter.fond;
            this.form.teachingUnit =  this.fundsCenter.teachingUnit;
            this.form.level = this.fundsCenter.level;
            this.form.division =  this.fundsCenter.division;
            this.form.description = this.fundsCenter.description;
            this.form.faculty =  this.fundsCenter.faculty;
            this.form.professor =  this.fundsCenter.professor;
            this.form.fundsCenterNumber = this.fundsCenter.fundsCenterNumber;
            this.form.costCenter =  this.fundsCenter.costCenter;
        },
        methods: {
            onSubmit() {
                if (this.loaded) {
                    ...
                    this.success = false;
                    this.errors = {};
                    axios.patch('/fundsCenter/'+this.fundsCenter.id, this.form)
                        .then(response => {
